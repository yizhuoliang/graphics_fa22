...
description = `<b>Notes for Tuesday Sept 27</b>
               <p>
...
setDescription(description + \`
   <p><img src=imgs/xform_line.png width=470>
   \`);
`,
...
\`);
setDescription(description + \`
   <p><img src=imgs/point_and_direction.png width=470>
   \`);
`,
...
\`);
setDescription(description + \`
   <p><img src=imgs/halfspace.png width=470>
   \`);
`,
...
<p>
Each plane defines a different inside/outside
halfspace.
</blockquote>
\`);
setDescription(description + \`
   <p><img src=imgs/halfspace_normal.png width=470>
   \`);
`,
...
<blockquote>
<b>A unit cube can be defined by the following 6 constraints:</b>
<blockquote>
<pre>
x &ge; -1      x &le; 1
y &ge; -1      y &le; 1
...
\`);
setDescription(description + \`
   <p><img src=imgs/cube.png width=470>
   \`);
`,
...
\`);
setDescription(description + \`
   <p><img src=imgs/ray_halfspace.png width=470>
   \`);
`,
...
\`);
setDescription(description + '<p><div><img src=imgs/four_cases.png width=470></div>');
`,
...
\`);
setDescription(description + \`
   <p><img src=imgs/ray_cube.png width=470>
   <p>&nbsp;
   <p><img src=imgs/xform_cube.png width=470>
   \`);
`,
...
\`);
setDescription(description + \`
   <p><img src=imgs/mtranslate.png width=470>
   <p><img src=imgs/mscale.png width=470>
   \`);
`,
...
Rotate about z:
<code>&nbsp; &nbsp; x y z &nbsp;&rarr;&nbsp;  cx-sy sx+cy z</code>
...
setDescription(description + \`
   ...
   <br>&nbsp; &nbsp; &nbsp; <img src=imgs/mrotatey.png width=338>
   <br>&nbsp; &nbsp; &nbsp; <img src=imgs/mrotatez.png width=338>
   \`);
`,
