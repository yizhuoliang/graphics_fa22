...
description = `<b>Notes for Tuesday Nov 1</b>
               <p>
	       Splines`;
...
They have all sorts of applications,
from designing text fonts
...
\`);
setDescription(description + '<p><img src=imgs/3d_hand.png width=475>');
`,
...
In 2D, the general form for such a curve is:
<blockquote><code>
...
<p>
Each curve
will have both position and direction vectors:
...
so various clever people
have found much easier ways to specify
parametric cubic curves.
The trick is to use <i>key points</i>.
<p>
Suppose, for example, you are a rocket scientist
who wants to specify the measured position and
...
specifying various points
to define cubic segments,
...
4 cubic polynomials
(see the corresponding curves to the right):
<p>
<center><code>
...
For each way that we would like to define
...
\`);
setDescription(description + '<p><img src=imgs/hermite_basis_functions.png width=475>');
`,
...
\`);
setDescription(description + '<p><img src=imgs/bezier3.png width=475>');
`,
...
<blockquote>
B&eacute;zier splines are popular partly because
...
\`);
setDescription(description + '<p><img src=imgs/two_beziers.png width=475>');
`,
...
<code><font color=#00a000>P<sub>i</sub></font></code>
and
<code><font color=#00a000><font color=blue>P<sub>i+1</sub></font></font></code>,
we use the locations of the four successive key points
<code><font color=red>P<sub>i-1</sub></font></code>,
<code><font color=#00a000>P<sub>i</sub></font></code>,
<code><font color=blue>P<sub>i+1</sub></font></code>,
<code><font color=violet>P<sub>i+2</sub></font></code>.
In particular, we do a weighted
sum of four cubic equations:

<p>
<pre>        <b>(</b> <font color=red>( -t<sup>3</sup> + 2t<sup>2</sup> - t    ) * P<sub>i-1</sub></font> +
          <font color=#00a000>( 3t<sup>3</sup> - 5t<sup>2</sup>     + 2) * P<sub>i&nbsp;&nbsp;</sub></font> +
          <font color=blue>(-3t<sup>3</sup> + 4t<sup>2</sup> + t    ) * P<sub>i+1</sub></font> +
          <font color=violet></sub>( 2t<sup>3</sup> - 2t<sup>2</sup>        ) * P<sub>i+2</sub></font> <b>) / 2</b></pre>
...
<th width=50><big><big><big>&bull;
<td><big><big><pre>
<font color=red>-1/2</font> <font color=#00a000> 3/2</font> <font color=blue>-3/2</font> <font color=violet> 1/2</font>
<font color=red>  1 </font> <font color=#00a000>-5/2</font> <font color=blue>  2 </font> <font color=violet>-1/2</font>
<font color=red>-1/2</font> <font color=#00a000>  0 </font> <font color=blue> 1/2</font> <font color=violet>  0 </font>
<font color=red>  0 </font> <font color=#00a000>  1 </font> <font color=blue>  0 </font> <font color=violet>  0 </font>
<th width=50><big><big><big>&bull;
<td><code><big><big>
<font color=red>P<sub>i-1</sub></font> <br>
<font color=#00a000>P<sub>i</sub></font> <br>
<font color=blue>P<sub>i+1</sub></font> <br>
<font color=violet>P<sub>i+2</sub></font>
<th width=100> &nbsp;
</tr></table>
</center>
...
\`);
setDescription(description + '<p><img src=imgs/catmull_rom_basis.png width=348>'
                           + '<p><img src=imgs/catmull_rom_curve.png width=475>');
`,
...
\`);
setDescription(description + '<p><img src=imgs/flask_and_fish.png width=475>');
`,
